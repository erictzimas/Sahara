...
clear = Button(
    ...
    bg="white",
    cursor="hand2",
    command=lambda: btn_clear(event),
...
X = Button(
    ...
    bg="black",
    cursor="hand2",
    command=lambda: btn_click("x"),
).grid(row=3, column=4, columnspan=1, padx=1, pady=1)
POW = Button(
    btns_frame,
    text="x^n",
    fg="black",
...
equals = Button(
    ...
    bg="white",
    cursor="hand2",
    command=lambda: btn_equal(event),
).grid(row=4, column=3, columnspan=3, padx=1, pady=1)
